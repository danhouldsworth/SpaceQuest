...
function impossible(){
    ...
    for (var count = 0; count < 100; count++)
        gameObjects.push(new Asteroid( (Math.random()-0.5) * 0.1*w, (Math.random()-0.5) * 8*h, 0.2 * (Math.random() - 0.5), 0.2 * (Math.random() - 0.5), 200 * Math.random(), 0.01 * (Math.random() - 0.5)));
    ...
    // gameObjects.push(new Asteroid( 0, 0.4*h,  0,0, 200, 0));
    // gameObjects.push(new Asteroid( 0, -0.4*h, 0,0, 200, 0));
    // gameObjects.push(new Asteroid( 0.5*w, -0.4*h, 0,0, 200, 0));
